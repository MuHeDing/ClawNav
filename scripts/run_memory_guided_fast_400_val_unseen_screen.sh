...
DATA_PATH=${DATA_PATH:-/ssd/dingmuhe/Embodied-task/JanusVLN/data/datasets/r2r/val_unseen/400_val_unseen.json.gz}
...
OUTPUT_PATH=${OUTPUT_PATH:-results/clawnav_openclaw_qwen_memory_guided_fast_400_val_unseen_${RUN_TIMESTAMP}}
SMOKE_OUTPUT=${SMOKE_OUTPUT:-results/clawnav_openclaw_qwen_memory_guided_fast_400_val_unseen_smoke_${RUN_TIMESTAMP}}
...
export MASTER_PORT_SMOKE MASTER_PORT_EVAL POLL_SECONDS OUTPUT_PATH SMOKE_OUTPUT
