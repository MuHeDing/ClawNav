...
HARNESS_MEMORY_BACKEND=${HARNESS_MEMORY_BACKEND:-spatial_http}
HARNESS_MEMORY_SOURCE=${HARNESS_MEMORY_SOURCE:-episode-local}
OPENCLAW_SERVICE_REGISTRY=${OPENCLAW_SERVICE_REGISTRY-}
...
export OPENCLAW_SERVICE_REGISTRY
export OPENCLAW_ENABLE_SUBAGENT_CRITIC OPENCLAW_ENABLE_SUBAGENT_MEMORY_CURATOR
export CHECK_GATEWAY=${CHECK_GATEWAY:-0}
export REQUIRE_GATEWAY=${REQUIRE_GATEWAY:-1}
export REQUIRE_OPENCLAW_CLI_ADAPTER=${REQUIRE_OPENCLAW_CLI_ADAPTER:-1}
