...
OPENCLAW_STOP_VERIFICATION_MODE=${OPENCLAW_STOP_VERIFICATION_MODE:-off}
OPENCLAW_POLICY_MEMORY_CONTEXT_ENABLED=${OPENCLAW_POLICY_MEMORY_CONTEXT_ENABLED:-1}
...
/ssd/dingmuhe/anaconda3/envs/janusvln/bin/torchrun --nproc_per_node="${NPROC_PER_NODE}" \
  ...
  --openclaw_stop_verification_mode "${OPENCLAW_STOP_VERIFICATION_MODE}" \
