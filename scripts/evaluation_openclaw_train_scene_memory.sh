...
OUTPUT_PATH=${OUTPUT_PATH:-results/clawnav_openclaw_train_scene_memory}
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-4}
MASTER_PORT=${MASTER_PORT:-20392}
SPATIAL_MEMORY_URL=${SPATIAL_MEMORY_URL:-http://127.0.0.1:8022}
MEMORY_MANIFEST_PATH=${MEMORY_MANIFEST_PATH:-results/manifests/train_scene_memory_manifest.json}
